function [r0, v0]  = coe2rv(a, e, Omega, i, omega, theta, mu)
...
%  v0 = velocity vector wrt S_0 [km/s]
    ...
    % r0 = (r_vect*R_P20)'; % position vector in S0(ECI) [km]
    % v0 = (v_vect*R_P20)'; % velocity vector in S0(ECI) [km/s]
    r0 = R_ECI2ORB'*r_vect; % position vector in S0(ECI) [km]
    v0 = R_ECI2ORB'*v_vect; % velocity vector in S0(ECI) [km/s]
end